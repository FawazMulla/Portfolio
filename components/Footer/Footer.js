const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/FawazMulla',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/mohammed-fawaz-mulla-134b1928a/',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Email',
      url: 'mailto:fawazmulla5@gmail.com?subject=From%20Portfolio%20Website"',
      icon: (
      ...
      <div className="container">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {currentYear} Fawaz Portfolio. All rights reserved.</p>
            <p>Built with React, curiosity, and ❤️ for learning.</p>
          </div>
