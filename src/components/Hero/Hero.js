      ...
      <div className="container">
        <div className="hero-content">
          ...
          <p className="hero-description">
            ...
            Currently pursuing my Information Technology degree while building real-world projects 
          ...
          <div className="hero-social">
            ...
            <a href="mailto:sarah.johnson@university.edu" className="social-link">
          ...
          <div className="profile-section">
            <div className="profile-photo">
              ...
              <div className="profile-placeholder" style={{display: 'none'}}>
                ...
                <p>Add your photo to<br/>/public/images/profile-photo.jpg</p>
              </div>
            </div>
          </div>
