      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <div className="footer-brand">
              ...
              <p>
                A passionate IT student exploring the world of technology through hands-on projects 
                and continuous learning. Always excited to connect and collaborate!
              </p>
            </div>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            ...
            <p>Built with React & a passion for learning</p>
          </div>
