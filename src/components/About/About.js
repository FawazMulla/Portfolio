        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <div className="about-description">
              <p>
                I'm currently a 3rd year Information Technology student with a deep passion for 
                software development and emerging technologies. My academic journey has been focused 
                on building a strong foundation in programming, system design, and problem-solving 
                while working on practical projects that challenge my skills.
              </p>
              
              <p>
                Through coursework and personal projects, I've gained experience in web development, 
                database management, and software engineering principles. I enjoy tackling complex 
                problems and turning ideas into functional applications that can make a difference.
              </p>

              <p>
                When I'm not studying or coding, I love exploring new technologies, contributing to 
                open-source projects, and sharing knowledge with fellow students. I believe in 
            ...
            <div className="about-highlights">
              ...
              <div className="highlight-item">
                ...
                <div>
                  <h4>Team Player</h4>
                  <p>Collaborating effectively on group projects and study sessions</p>
                </div>
              </div>
            </div>
          </div>
